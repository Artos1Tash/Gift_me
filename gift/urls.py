...
from gift.views import UserView, GiftView, NewsView, RoomView, CartView, GiftImageView, CartProductView
...
urlpatterns = [
    ...
    path('cart_product/', CartProductView.as_view({'get': 'list'})),
    path('cart_product/<int:pk>/', CartProductView.as_view({'get': 'retrieve', 'post': 'create', 'put': 'update', 'delete': 'destroy'})),
